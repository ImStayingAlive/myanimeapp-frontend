    ...
    return (
        <div>
            <div style={{height: "63vh"}}>
                <div className="lobby-bg landingGradient" style={{height: "55vh"}}>
                    <div className="bg-cover backDrop h-full"
                         style={{backgroundImage: `url('https://cdn.necrocloud.eu/shows/Wise-Mans-Grandchild/media/wiseMansGrandchildBackground.jpg')`}}/>
                </div>
