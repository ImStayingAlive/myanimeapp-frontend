...
import {ShowModel, showStore} from '../../../app/show/ShowFacade';
...
const ShowCard = (props) => {
    ...
    // Set Data
    const show: ShowModel | boolean = showStore.getShow(props.show.name)
    if (show) {
        ...
        if (props.wide) {
            return (
                <div onClick={() => showPopupStore.open(show.name)}
                    ...
                    <img src={show.logo} alt="Show Logo" />
